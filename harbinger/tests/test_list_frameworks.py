...
class TestListFrameworks(unittest.TestCase):
    def setUp(self):
        ...
        self.test_object = ListFrameworks(app=mock.Mock(), app_args=self.args)

    def test_get_description(self):
        _description = "lists all supported frameworks"
        self.assertEqual(_description, self.test_object.get_description())
    ...
    def test_take_action(self, mock_utils, mock_list_frameworks):
        ...
        mock_list_frameworks.assert_called_once_with(_supported_frameworks)
